        ...
        {options.map((option, index) => (
          ...
          >
            <div className="flex items-center">
              <div className={`w-5 h-5 rounded-full border-2 mr-3 flex items-center justify-center ${selectedOption === option.id ? 'border-black' : 'border-gray-300'}`}>
                {selectedOption === option.id && <div className="w-3 h-3 rounded-full bg-black"></div>}
              </div>
