...
<div className="md:flex md:justify-between md:items-center mb-8 gap-16">
            ...
            <div className="mb-6 md:mb-0">
              <a href="https://www.glambeauty.com/" className="flex items-center space-x-3">
               <Image src={logo}/>
...
{/* Nav links */}
            <div className="grid grid-cols-2  sm:grid-cols-4 ">
              <div className=''>
                <h2 className="mb-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">Glam Beauty</h2>
