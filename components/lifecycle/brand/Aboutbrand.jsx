      ...
      <div className='flex gap-8 mt-6'>
        ...
        <div className='w-1/2 space-y-6 leading-relaxed'>
          <p className={`${lexendDeca.className} text-sm`}>
            ...
            <br />
            <br />
            Discover <strong>foundations</strong> that work with your skin to tackle dryness, redness, and acne, along with <strong>concealers</strong> that match every skin type. Choose <strong>mascaras</strong> that lengthen, thicken, define, or enhance the health of your lashes. Opt for <strong>eyeshadows</strong> to add precision or create a smouldering smoky eye. Pick up lipsticks, liners, glosses, or stains to craft a natural look or achieve high drama – with such quality lip products, you'll enjoy a look that lasts all day.
            <br />
            <br />
