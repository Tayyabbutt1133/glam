...
const Para = ({ children }) => {
    return (
      <p className={`mb-3 ${lexendDeca.className} text-[16px] lg:text-[20px]`}>
        {children}
      </p>
    );
  };
function page() {
  return <main className=" mx-4 sm:mx-6 lg:mx-28 xl:mx-32">
    ...
    <Para>We reserve the right to update these Terms from time to time and any changes will be notified to you via a suitable announcement on the Website. It is your responsibility to check for such changes. The changes will apply to the use of the Website after we have given such announcement. If you do not wish to accept the new Terms you should not continue to use the Website. If you continue to use the Website after the date on which the change comes into effect, your use of the Website indicates your agreement to be bound by the new Terms; and modify or withdraw, temporarily or permanently, this Website and the material contained within (or any part) without notice to you and you confirm that we shall not be liable to you for any modification to or withdrawal of the Website or its contents.</Para>
    <Head>Registration</Head>
    <Para>You warrant that the personal information which you are required to provide when you register is true, accurate, current and complete in all respects; and you are not impersonating any other person or entity. <br /> <br />
    The products purchased on this site are for private and domestic use only and are not for re sale. You will notify us immediately of any changes to the personal information by e-mailing or telephoning our customer service representatives at feedback@glambeauty.com.</Para>
    <Head>Privacy Policy</Head>
    <Para>We will treat all your personal information as confidential and we will only use it in accordance with our Privacy Policy. <br /> <br />
    When you shop on this Website, we will ask you to input personal details in order for us to identify you, such as your name, e-mail address, billing address, delivery address, credit card or other payment information. We confirm that this information will be held by us in accordance with the registration we have with the Data Commissioner s office.</Para>
    <Head>Protecting Your Security</Head>
    <Para>To ensure that your credit, debit or charge card is not being used without your consent, we will validate name, address and other personal information supplied by you during the order process against appropriate third party databases.<br /> <br />
...
By accepting these terms and conditions you consent to such checks being made. In performing these checks personal information provided by you may be disclosed to a registered Credit Reference Agency which may keep a record of that information. You can rest assured that this is done only to confirm your identity, that a credit check is not performed and that your credit rating will be unaffected. All information provided by you will be treated securely and strictly in accordance with the Data Protection Act 1998.</Para>
    
        <Head>Compliance</Head>
        <Para>The Website may only be used for lawful purposes and in a lawful manner. You agree to comply with all applicable laws, statutes and regulations regarding the Website and its use. You agree not to upload or transmit through the Website any computer viruses or anything else designed to interfere with, interrupt or disrupt the normal operating procedures of a computer; and any material which is defamatory, offensive or of an obscene character.</Para>

        <Head>Indemnity</Head>
        <Para>You agree to fully indemnify, defend and hold us, and our officers, directors, employees and suppliers, harmless immediately on demand, from and against all claims, losses, costs and expenses, including reasonable legal fees, arising out of any breach of these Terms by you, or any other liabilities arising out of your use of this Website or any other person accessing the Website using your personal information. </Para>

        <Head>Third Party Links</Head>
        <Para>As a convenience to our customers, the Website may include links to other websites or material which is beyond our control. For your information, we are not responsible for such websites or material nor do we review or endorse them. We will not be liable, whether directly or indirectly, for the privacy practices or content of such websites nor for any damage, loss or offence caused or alleged to be caused in connection with, the use of or reliance on any such advertising, content, products, materials or services available on such external websites or resources.</Para>

        <Head>Orders</Head>
<Para>All orders are subject to acceptance and availability. If the goods ordered are not available you will be notified by e-mail (or by other means if no e-mail address has been provided). You will have the option either to wait until the item is available from stock or to cancel your order.<br /> <br />
...
We do not allow collections.</Para>            

<Head>Cancellation Rights</Head>
<Para>Where you have purchased the goods or services as a consumer (i.e. for private use as opposed to business use), you are entitled to cancel any contract completed with us within 14 days from the day on which you acquire physical possession of the goods.<br /> <br />
If you wish to cancel a contract pursuant to this clause please see our Returns Policy for further details on how to do this.</Para>


<Head>Price and Payment</Head>
<Para>All prices shown are inclusive of VAT (only where applicable – see below) at the current rates and are correct at the time of entering the information onto the system. We reserve the right, however, to change prices at any time without notice to you. If your delivery address is within the United Kingdom, no additional taxes will be charged to you.
