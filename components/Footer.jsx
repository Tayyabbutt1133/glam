        ...
        <div className="mx-auto w-full ">
          <div className="md:flex md:justify-between md:items-center my-10">
            ...
            <div className=" flex flex-col gap-8">
              ...
              <p
                className={`text-sm lg:text-[14px] 2xl:text-[16px]  text-[#7E7E7E] md:w-64 ${lexendDeca.className} font-normal`}
              >
                We are the fastest-growing beauty retailer, always offering huge
                discounts off the RRP.
              </p>
              <div name="socials" className=" flex gap-4">
                ...
                <Link href={"https://www.instagram.com/glambeautycom/"}>
                  <Image
                    className="hover:scale-110 transition-transform duration-300 cursor-pointer"
                    src={Insta}
                    alt="Instagram icon"
                ...
                <Link href={"https://www.tiktok.com/@glambeautyuk"}>
                  <Image
                    className="hover:scale-110 transition-transform duration-300 cursor-pointer"
                    src={tik}
                    alt="Tiktok icon"
            ...
            <div className="grid px-3 py-2 sm:px-0 mt-4 grid-cols-1 space-y-1 md:grid-cols-4 sm:space-y-0 lg:ml-16 md:ml-6">
              ...
              <div className=" md:hidden">
                ...
                <ul
                  className={`text-[#8B929D] lg:text-[14px] xl:text-[16px] text-sm pb-3 space-y-3 ${
              ...
              <div className=" hidden md:block">
                ...
                <ul
                  className={`text-[#8B929D] lg:text-[14px] 2xl:text-[16px] text-sm pb-3 space-y-3 ${lexendDeca.className} font-normal transition-all duration-300 ease-in-out max-h-screen opacity-100' `}
                >
                  <li className="">
                    <a href="#" className="hover:underline">
                      About us
              ...
              <div className=" md:hidden">
                ...
                <ul
                  className={`text-[#8B929D] text-sm lg:text-[14px] xl:text-[16px] space-y-3 ${
                    lexendDeca.className
                  } font-normal transition-all duration-300 ease-in-out ${
                    openSections.helpInfo
                      ? "max-h-screen opacity-100"
              ...
              <div className=" hidden md:block">
                ...
                <ul
                  className={`text-[#8B929D] text-sm lg:text-[14px] 2xl:text-[16px] space-y-3 ${lexendDeca.className} font-normal transition-all duration-300 ease-in-out  max-h-screen opacity-100`}
                >
                  <li className="">
                    <a href="#" className="hover:underline">
                      Delivery Information
          ...
          <div className="sm:flex sm:items-center sm:justify-between my-4">
            ...
            <div className="flex sm:justify-between mt-2 sm:mt-0 items-center gap-3">
              <Link
                className="grid place-items-center w-[50px] h-[32px] border border-gray-300 rounded-[8px]"
                href="#"
              >
                <Image
              ...
              <Link
                className="flex justify-end w-[50px] h-[32px] border border-gray-300 rounded-[8px]"
                href="#"
              >
                <Image
                  className="hover:scale-110 transition-transform duration-300"
