    ...
    <div key={product.id} className=" mx-0 2xl:mx-0 mb-2">
      ...
      >
        ...
        <div className="px-4 pb-4 flex-grow flex flex-col sm:min-h-[240px]">
          ...
          <button
            className={`w-full bg-black text-white py-2 text-xs md:text-base mx-auto rounded-md hover:bg-[#CF8562] font-normal transition duration-200 flex justify-center items-center text-center ${lexendDeca.className}`}
