    ...
    <>
      <div className="flex w-full relative">
        <div className="w-1/2 relative">
          {/* Content */}
          <div className="ml-20 absolute top-2/4 flex flex-col max-w-[70%] items-start ">
            <div className="text-start text-white">
              <h1 className="text-3xl font-bold">ESTEE LAUDER</h1>
            ...
            <div
              className={`grid grid-cols-2 gap-4 mt-8 ${jost.className} font-medium text-xl`}
            >
              <button className="bg-white text-black py-2 px-8 rounded">
                SHOP SKINCARE
              </button>
              <button className="bg-white text-black py-2 px-8 rounded">
                SHOP NEW IN
