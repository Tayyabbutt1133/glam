...
const Payments = () => {
  ...
  return (
    <div className="mx-auto rounded-lg">
      ...
      {!isFormOpen && (
        <button
          className={`flex items-center justify-center w-full p-3 border border-dashed border-gray-300 rounded-md text-gray-500 hover:text-gray-700 hover:border-gray-500 ${jost.className}`}
      ...
      {isFormOpen && (
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`md:w-[30%] w-full uppercase bg-black text-white p-3 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-600 mt-8 ${jost.className}`}
          >
            Save Card Details
          </button>
        </form>
