...
export default function Promo() {
  return (
    <>
      <div name="promo-parent" className="hidden lg:flex promo-parent bg-[#202020]">
        <Container>
          <div className="flex justify-between items-center lg:px-24 xl:px-28 h-12">
            ...
            <div class="w-[1px] h-6 bg-[#F7F7F7A6]"></div>
            <h1 className={`text-white text-[13px] 2xl:text-[16px] ${lexendDeca.className}`}>
              <span className=" font-bold">BUY NOW, PAY LATER </span>available
            </h1>
            <div class="w-[1px] h-6 bg-[#F7F7F7A6]"></div>
            <h1 className={`text-white text-[13px] 2xl:text-[16px] ${lexendDeca.className}`}>
              {" "}
