    ...
    const fetchCategoriesAndProducts = async () => {
      try {
        ...
        setMainCategory({
          ...
          name: decodeHtml(mainCategoryResponse.data.name), // Decode &amp;
        });
        ...
        setSubCategories(
          subCategoryResponse.data.map((category) => ({
            ...category,
            name: decodeHtml(category.name), // Decode &amp;
          }))
        );
        ...
        setHotSellingProducts(
          hotSellingResponse.data.map((product) => ({
            ...product,
            name: decodeHtml(product.name), // Decode &amp;
          }))
        );
        ...
        setStaffPicks(
          staffPicksResponse.data.map((product) => ({
            ...product,
            name: decodeHtml(product.name), // Decode &amp;
          }))
        );
